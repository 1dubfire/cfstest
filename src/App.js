...
import Jobs from "./components/blog/BlogGridSidebar";
import OceanAir from "./pages/OceanAir";
import Customs from "./pages/Customs";
import Warehousing from "./pages/Warehousing";
import OurTeam from "./pages/OurTeam";
import CarrierFAQ from "./pages/CarrierFAQ";
        ...
        <Router>
            <PageScrollTop>
                <Switch>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/jobs/:id"}`} exact component={BlogDetails}/>
                    ...
                    <Route path={`${process.env.PUBLIC_URL + "/OTR"}`} exact component={OTR}/>
                    <Route path={`${process.env.PUBLIC_URL + "/jobs"}`} exact component={Jobs}/>
                    <Route path={`${process.env.PUBLIC_URL + "/ocean-air"}`} exact component={OceanAir}/>
                    <Route path={`${process.env.PUBLIC_URL + "/customs"}`} exact component={Customs}/>
                    <Route path={`${process.env.PUBLIC_URL + "/warehousing"}`} exact component={Warehousing}/>
                    <Route path={`${process.env.PUBLIC_URL + "/our-team"}`} exact component={OurTeam}/>
                    <Route path={`${process.env.PUBLIC_URL + "/carrier-faq"}`} exact component={CarrierFAQ}/>
